            ...
            <div className="max-w-2xl mx-auto">
              <Card className="bg-card/50 backdrop-blur-sm border-border/50">
                <CardHeader className="text-center">
                  <CardTitle className="text-3xl gradient-text">{t('productDetails.contactForm.title')}</CardTitle>
                  <CardDescription className="text-lg">
                    {t('productDetails.contactForm.description')}
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Form {...form}>
                    <form onSubmit={form.handleSubmit(onContactFormSubmit)} className="space-y-6">
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            <FormLabel>{t('productDetails.formLabels.messageOptional')}</FormLabel>
                            <FormControl>
                              <Textarea placeholder={t('productDetails.formPlaceholders.message')} className="min-h-[100px]" {...field} />
                            </FormControl>
                            <FormMessage />
                          </FormItem>
                        )}
