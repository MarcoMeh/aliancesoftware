  ...
  return (
    <section
      className="relative min-h-screen flex items-center justify-center py-20 px-4 md:px-8 overflow-hidden
                 bg-gradient-background text-card-foreground"
    >
        ...
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Button
              variant="outline"
              size="lg"
              className={`group px-8 py-3 text-lg font-semibold rounded-full shadow-md hover:shadow-lg transition-all duration-300 border-white text-white hover:bg-white hover:text-primary ${isRtl ? 'flex-row-reverse' : ''}`}
