    ...
    >
      ...
      >
        <div className="max-w-4xl mx-auto animate-fade-in">
          ...
          {/* Main Heading - MODIFIED LINE HERE */}
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-extrabold mb-5 leading-tight text-white"> {/* Keep text-white on h1 for "Solutions & Services" */}
            <span className="text-red-500">{t('hero.mainHeading', 'Innovative Software ')}</span> {/* <-- CHANGE THIS LINE */}
